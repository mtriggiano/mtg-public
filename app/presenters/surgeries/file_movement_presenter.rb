class Surgeries::FileMovementPresenter < SaleApplicationPresenter
  	presents :movement
	...
	def action_links
		content_tag :div do
			concat(link_to_show surgeries_file_movement_path(movement.id, sale_file_id: movement.file_id), {data:{target: "#show_movement_modal", toggle: "modal", form: true}})
		end
	end
end
