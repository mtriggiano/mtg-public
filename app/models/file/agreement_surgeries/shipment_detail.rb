class AgreementSurgeries::ShipmentDetail < ExpedientShipmentDetail
	...
	if consumed
      {
        steps:[
        {
       	  title: "El producto fue consumido por el cliente.", 
       	  description: "El producto fue asociado a un consumo con estado #{consumption_state}. Se consumieron #{consumed_quantity} #{product_measurement}."}
        ]
      }
	else
