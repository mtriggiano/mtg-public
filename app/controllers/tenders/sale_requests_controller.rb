class Tenders::SaleRequestsController < ApplicationController
	include Attachable
	include Fileable
	...
	include BasicCrud
  	...
  	private
  		...
  		def sale_request_params
  			params.require(:tenders_sale_request).permit(:entity_id, :init_date, :final_date, :urgency, :state, :number, :observation, :request_type, :file_id,
