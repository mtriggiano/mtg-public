...
//         })
//       }},
//     {extend: 'excelHtml5', filename: "reporte" ,text: '<i class="fas fa-file-excel"></i> Exportar a excel', className: "btn-light border", title: () => {
...
//   var invisibles = []
//   $("table thead tr:last th").each(function(index){
...
//   if ( state && !queryDict.not_draw ) {
//     $table.columns().eq( 0 ).each( function ( colIdx ) {
//     var colSearch = state.columns[colIdx].search;
//     if ( colSearch.search != "" ) {
//       $('input', $('.yadcf-filter')[colIdx]).val( colSearch.search );
//     }
//    });
//    $table.draw();
//   }
...
//     $("#paginated_table_paginate").remove()
//     return dataTable = null;
//   }
// };
//
...
// });
//
// const setFillPopover = () => {
//   $("input.yadcf-filter").each( function(){
//     console.log( $(this).val() )
//     if ($(this).val() != ""){
//       $(this).closest('th').click()
//     }
//   })
// }
