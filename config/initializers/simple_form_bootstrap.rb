...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'col-md-4 col-lg-3 col-form-label col-form-label-sm'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-md-8 col-lg-9' do |ba|
  ...
  config.wrappers(:vertical_radio_and_checkboxes, tag: 'div',
    ...
    item_label_class: 'form-check-label') do |b|
      b.use :html5
      b.optional :readonly
      b.use :label, class: 'form-control-label col-sm-3'
  ...
  config.wrappers :horizontal_file, tag: 'div', class: 'form-group row align-items-center', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_input_group, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-9' do |ba|
      ba.wrapper tag: 'div', class: 'input-group flex-nowrap' do |append|
        append.use :input, class: 'form-control'
      end
  ...
  config.wrappers :inline_input, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label

    b.wrapper tag: 'div', class: 'input-group flex-nowrap' do |ba|
  ...
  config.wrappers :disabled_form do |b|
    b.use :input, disabled: true, class: 'form-control'
  end
