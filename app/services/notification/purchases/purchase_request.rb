class Notification::Purchases::PurchaseRequest < NotificationMaker
  ...
  def for_created
    ...
    super(title, body)
    #Activity::Purchases::PurchaseRequest.new(document.supplier.set_activity(current_user), document).for_new if document.supplier
  end
  ...
  def for_updated
    ...
    super(title, body)
    #Activity::Purchases::PurchaseRequest.new(document.supplier.set_activity(current_user), document).for_new
  end
